...
class KCEngineSnapshot(ctypes.Structure):
    _fields_ = [
        ...
        ("tutorial_mode", ctypes.c_bool),
        ("tutorial_orientation_complete", ctypes.c_bool),
        ("tutorial_reward_lesson_complete", ctypes.c_bool),
        ("tutorial_saboteur_follow_lesson_complete", ctypes.c_bool),
        ("tutorial_famine_trump_suit", ctypes.c_int32),
        ("tutorial_famine_off_suit", ctypes.c_int32),
        ("tutorial_famine_void_suit", ctypes.c_int32),
        ("variants", KCVariants),
        ...
        ("requisition_active_suits", ctypes.c_bool * SUIT_COUNT),
        ("requisition_player_suits", (ctypes.c_bool * SUIT_COUNT) * PLAYER_COUNT),
        ("requisition_target_players", ctypes.c_bool * PLAYER_COUNT),
        ("requisition_choice_confirmed", ctypes.c_bool * PLAYER_COUNT),
        ...
        ("requisition_individual_losses_remaining", ctypes.c_int32 * PLAYER_COUNT),
        ("requisition_competitive_rounds_remaining", ctypes.c_int32),
        ("requisition_expanded_rounds_remaining", ctypes.c_int32),
