...
@useResult
$Res call({
 String sessionID, double serverTime, int? seed,@JsonKey(readValue: _inviteCodeFromJson) String inviteCode, int? viewerID, int actionLogCount, bool isViewerTurn, List<OnlineEngineAction> legalActions,@JsonKey(fromJson: _variantsFromJson) KolkhozGameVariants variants,@JsonKey(fromJson: _controllersFromJson) List<KolkhozPlayerController> controllers, List<OnlinePlayerProfile> playerProfiles, bool ranked, bool browserJoinable, List<OnlineSeatPresence> seatPresence, int? turnPlayerID, double? turnDeadlineAt, bool started, double? lobbyCountdownEndsAt, List<OnlineEngineAction> gameLogActions, List<OnlineReaction> reactions, OnlineSeriesStatus? series, OnlineTournamentGameStatus? tournament, OnlineEngineSnapshot snapshot
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sessionID,  double serverTime,  int? seed, @JsonKey(readValue: _inviteCodeFromJson)  String inviteCode,  int? viewerID,  int actionLogCount,  bool isViewerTurn,  List<OnlineEngineAction> legalActions, @JsonKey(fromJson: _variantsFromJson)  KolkhozGameVariants variants, @JsonKey(fromJson: _controllersFromJson)  List<KolkhozPlayerController> controllers,  List<OnlinePlayerProfile> playerProfiles,  bool ranked,  bool browserJoinable,  List<OnlineSeatPresence> seatPresence,  int? turnPlayerID,  double? turnDeadlineAt,  bool started,  double? lobbyCountdownEndsAt,  List<OnlineEngineAction> gameLogActions,  List<OnlineReaction> reactions,  OnlineSeriesStatus? series,  OnlineTournamentGameStatus? tournament,  OnlineEngineSnapshot snapshot)  $default,) {final _that = this;
switch (_that) {
case _OnlineSessionUpdate():
return $default(_that.sessionID,_that.serverTime,_that.seed,_that.inviteCode,_that.viewerID,_that.actionLogCount,_that.isViewerTurn,_that.legalActions,_that.variants,_that.controllers,_that.playerProfiles,_that.ranked,_that.browserJoinable,_that.seatPresence,_that.turnPlayerID,_that.turnDeadlineAt,_that.started,_that.lobbyCountdownEndsAt,_that.gameLogActions,_that.reactions,_that.series,_that.tournament,_that.snapshot);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sessionID,  double serverTime,  int? seed, @JsonKey(readValue: _inviteCodeFromJson)  String inviteCode,  int? viewerID,  int actionLogCount,  bool isViewerTurn,  List<OnlineEngineAction> legalActions, @JsonKey(fromJson: _variantsFromJson)  KolkhozGameVariants variants, @JsonKey(fromJson: _controllersFromJson)  List<KolkhozPlayerController> controllers,  List<OnlinePlayerProfile> playerProfiles,  bool ranked,  bool browserJoinable,  List<OnlineSeatPresence> seatPresence,  int? turnPlayerID,  double? turnDeadlineAt,  bool started,  double? lobbyCountdownEndsAt,  List<OnlineEngineAction> gameLogActions,  List<OnlineReaction> reactions,  OnlineSeriesStatus? series,  OnlineTournamentGameStatus? tournament,  OnlineEngineSnapshot snapshot)?  $default,) {final _that = this;
switch (_that) {
case _OnlineSessionUpdate() when $default != null:
return $default(_that.sessionID,_that.serverTime,_that.seed,_that.inviteCode,_that.viewerID,_that.actionLogCount,_that.isViewerTurn,_that.legalActions,_that.variants,_that.controllers,_that.playerProfiles,_that.ranked,_that.browserJoinable,_that.seatPresence,_that.turnPlayerID,_that.turnDeadlineAt,_that.started,_that.lobbyCountdownEndsAt,_that.gameLogActions,_that.reactions,_that.series,_that.tournament,_that.snapshot);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,sessionID,serverTime,seed,inviteCode,viewerID,actionLogCount,isViewerTurn,const DeepCollectionEquality().hash(_legalActions),variants,const DeepCollectionEquality().hash(_controllers),const DeepCollectionEquality().hash(_playerProfiles),ranked,browserJoinable,const DeepCollectionEquality().hash(_seatPresence),turnPlayerID,turnDeadlineAt,started,lobbyCountdownEndsAt,const DeepCollectionEquality().hash(_gameLogActions),const DeepCollectionEquality().hash(_reactions),series,tournament,snapshot]);
...
/// Create a copy of OnlineSessionUpdate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sessionID = null,Object? serverTime = null,Object? seed = freezed,Object? inviteCode = null,Object? viewerID = freezed,Object? actionLogCount = null,Object? isViewerTurn = null,Object? legalActions = null,Object? variants = null,Object? controllers = null,Object? playerProfiles = null,Object? ranked = null,Object? browserJoinable = null,Object? seatPresence = null,Object? turnPlayerID = freezed,Object? turnDeadlineAt = freezed,Object? started = null,Object? lobbyCountdownEndsAt = freezed,Object? gameLogActions = null,Object? reactions = null,Object? series = freezed,Object? tournament = freezed,Object? snapshot = null,}) {
