...
mixin _$OnlineEngineSnapshot {
 ...
 int get year; int get phase; int get currentPlayer; int get waitingPlayer; bool get waitingForExternalAction; int get lead; int get trumpSelector; int get trump; int get trickCount; bool get isFamine; List<OnlinePlayerSnapshot> get players; List<OnlineSuitCardsSnapshot> get jobPiles; List<OnlineSuitCardsSnapshot> get revealedJobs; List<OnlineEngineCard> get managedRewardOffers; List<int> get claimedJobs; List<OnlineSuitValueSnapshot> get workHours; List<OnlineSuitCardsSnapshot> get jobBuckets; List<OnlineSuitCardsSnapshot> get accumulatedJobCards; List<OnlineTrickPlaySnapshot> get currentTrick; int get currentTrickWinner; List<OnlineTrickPlaySnapshot> get lastTrick; int get lastWinner; List<OnlineSuitCardsSnapshot> get exiled; List<OnlineSuitPlayersSnapshot> get exiledPlayers; List<OnlineAssignmentSnapshot> get pendingAssignments; List<OnlineRequisitionSnapshot> get requisitionEvents; List<OnlineTrickPlaySnapshot> get requisitionHeldNominations;@JsonKey(fromJson: _transitionEventsFromJson) List<EngineTransitionEvent> get transitionEvents; List<OnlineScoreSnapshot> get scores; int get winnerID; List<int> get swapConfirmed; List<int> get swapCount; List<int> get passConfirmed; OnlineEngineCard get finalYearTrumpCard;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OnlineEngineSnapshot&&(identical(other.year, year) || other.year == year)&&(identical(other.phase, phase) || other.phase == phase)&&(identical(other.currentPlayer, currentPlayer) || other.currentPlayer == currentPlayer)&&(identical(other.waitingPlayer, waitingPlayer) || other.waitingPlayer == waitingPlayer)&&(identical(other.waitingForExternalAction, waitingForExternalAction) || other.waitingForExternalAction == waitingForExternalAction)&&(identical(other.lead, lead) || other.lead == lead)&&(identical(other.trumpSelector, trumpSelector) || other.trumpSelector == trumpSelector)&&(identical(other.trump, trump) || other.trump == trump)&&(identical(other.trickCount, trickCount) || other.trickCount == trickCount)&&(identical(other.isFamine, isFamine) || other.isFamine == isFamine)&&const DeepCollectionEquality().equals(other.players, players)&&const DeepCollectionEquality().equals(other.jobPiles, jobPiles)&&const DeepCollectionEquality().equals(other.revealedJobs, revealedJobs)&&const DeepCollectionEquality().equals(other.managedRewardOffers, managedRewardOffers)&&const DeepCollectionEquality().equals(other.claimedJobs, claimedJobs)&&const DeepCollectionEquality().equals(other.workHours, workHours)&&const DeepCollectionEquality().equals(other.jobBuckets, jobBuckets)&&const DeepCollectionEquality().equals(other.accumulatedJobCards, accumulatedJobCards)&&const DeepCollectionEquality().equals(other.currentTrick, currentTrick)&&(identical(other.currentTrickWinner, currentTrickWinner) || other.currentTrickWinner == currentTrickWinner)&&const DeepCollectionEquality().equals(other.lastTrick, lastTrick)&&(identical(other.lastWinner, lastWinner) || other.lastWinner == lastWinner)&&const DeepCollectionEquality().equals(other.exiled, exiled)&&const DeepCollectionEquality().equals(other.exiledPlayers, exiledPlayers)&&const DeepCollectionEquality().equals(other.pendingAssignments, pendingAssignments)&&const DeepCollectionEquality().equals(other.requisitionEvents, requisitionEvents)&&const DeepCollectionEquality().equals(other.requisitionHeldNominations, requisitionHeldNominations)&&const DeepCollectionEquality().equals(other.transitionEvents, transitionEvents)&&const DeepCollectionEquality().equals(other.scores, scores)&&(identical(other.winnerID, winnerID) || other.winnerID == winnerID)&&const DeepCollectionEquality().equals(other.swapConfirmed, swapConfirmed)&&const DeepCollectionEquality().equals(other.swapCount, swapCount)&&const DeepCollectionEquality().equals(other.passConfirmed, passConfirmed)&&(identical(other.finalYearTrumpCard, finalYearTrumpCard) || other.finalYearTrumpCard == finalYearTrumpCard));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,year,phase,currentPlayer,waitingPlayer,waitingForExternalAction,lead,trumpSelector,trump,trickCount,isFamine,const DeepCollectionEquality().hash(players),const DeepCollectionEquality().hash(jobPiles),const DeepCollectionEquality().hash(revealedJobs),const DeepCollectionEquality().hash(managedRewardOffers),const DeepCollectionEquality().hash(claimedJobs),const DeepCollectionEquality().hash(workHours),const DeepCollectionEquality().hash(jobBuckets),const DeepCollectionEquality().hash(accumulatedJobCards),const DeepCollectionEquality().hash(currentTrick),currentTrickWinner,const DeepCollectionEquality().hash(lastTrick),lastWinner,const DeepCollectionEquality().hash(exiled),const DeepCollectionEquality().hash(exiledPlayers),const DeepCollectionEquality().hash(pendingAssignments),const DeepCollectionEquality().hash(requisitionEvents),const DeepCollectionEquality().hash(requisitionHeldNominations),const DeepCollectionEquality().hash(transitionEvents),const DeepCollectionEquality().hash(scores),winnerID,const DeepCollectionEquality().hash(swapConfirmed),const DeepCollectionEquality().hash(swapCount),const DeepCollectionEquality().hash(passConfirmed),finalYearTrumpCard]);

@override
String toString() {
  return 'OnlineEngineSnapshot(year: $year, phase: $phase, currentPlayer: $currentPlayer, waitingPlayer: $waitingPlayer, waitingForExternalAction: $waitingForExternalAction, lead: $lead, trumpSelector: $trumpSelector, trump: $trump, trickCount: $trickCount, isFamine: $isFamine, players: $players, jobPiles: $jobPiles, revealedJobs: $revealedJobs, managedRewardOffers: $managedRewardOffers, claimedJobs: $claimedJobs, workHours: $workHours, jobBuckets: $jobBuckets, accumulatedJobCards: $accumulatedJobCards, currentTrick: $currentTrick, currentTrickWinner: $currentTrickWinner, lastTrick: $lastTrick, lastWinner: $lastWinner, exiled: $exiled, exiledPlayers: $exiledPlayers, pendingAssignments: $pendingAssignments, requisitionEvents: $requisitionEvents, requisitionHeldNominations: $requisitionHeldNominations, transitionEvents: $transitionEvents, scores: $scores, winnerID: $winnerID, swapConfirmed: $swapConfirmed, swapCount: $swapCount, passConfirmed: $passConfirmed, finalYearTrumpCard: $finalYearTrumpCard)';
}
...
@useResult
$Res call({
 int year, int phase, int currentPlayer, int waitingPlayer, bool waitingForExternalAction, int lead, int trumpSelector, int trump, int trickCount, bool isFamine, List<OnlinePlayerSnapshot> players, List<OnlineSuitCardsSnapshot> jobPiles, List<OnlineSuitCardsSnapshot> revealedJobs, List<OnlineEngineCard> managedRewardOffers, List<int> claimedJobs, List<OnlineSuitValueSnapshot> workHours, List<OnlineSuitCardsSnapshot> jobBuckets, List<OnlineSuitCardsSnapshot> accumulatedJobCards, List<OnlineTrickPlaySnapshot> currentTrick, int currentTrickWinner, List<OnlineTrickPlaySnapshot> lastTrick, int lastWinner, List<OnlineSuitCardsSnapshot> exiled, List<OnlineSuitPlayersSnapshot> exiledPlayers, List<OnlineAssignmentSnapshot> pendingAssignments, List<OnlineRequisitionSnapshot> requisitionEvents, List<OnlineTrickPlaySnapshot> requisitionHeldNominations,@JsonKey(fromJson: _transitionEventsFromJson) List<EngineTransitionEvent> transitionEvents, List<OnlineScoreSnapshot> scores, int winnerID, List<int> swapConfirmed, List<int> swapCount, List<int> passConfirmed, OnlineEngineCard finalYearTrumpCard
});
...
/// Create a copy of OnlineEngineSnapshot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? year = null,Object? phase = null,Object? currentPlayer = null,Object? waitingPlayer = null,Object? waitingForExternalAction = null,Object? lead = null,Object? trumpSelector = null,Object? trump = null,Object? trickCount = null,Object? isFamine = null,Object? players = null,Object? jobPiles = null,Object? revealedJobs = null,Object? managedRewardOffers = null,Object? claimedJobs = null,Object? workHours = null,Object? jobBuckets = null,Object? accumulatedJobCards = null,Object? currentTrick = null,Object? currentTrickWinner = null,Object? lastTrick = null,Object? lastWinner = null,Object? exiled = null,Object? exiledPlayers = null,Object? pendingAssignments = null,Object? requisitionEvents = null,Object? requisitionHeldNominations = null,Object? transitionEvents = null,Object? scores = null,Object? winnerID = null,Object? swapConfirmed = null,Object? swapCount = null,Object? passConfirmed = null,Object? finalYearTrumpCard = null,}) {
  return _then(_self.copyWith(
...
as List<OnlineSuitCardsSnapshot>,managedRewardOffers: null == managedRewardOffers ? _self.managedRewardOffers : managedRewardOffers // ignore: cast_nullable_to_non_nullable
as List<OnlineEngineCard>,claimedJobs: null == claimedJobs ? _self.claimedJobs : claimedJobs // ignore: cast_nullable_to_non_nullable
...
as List<OnlineTrickPlaySnapshot>,currentTrickWinner: null == currentTrickWinner ? _self.currentTrickWinner : currentTrickWinner // ignore: cast_nullable_to_non_nullable
as int,lastTrick: null == lastTrick ? _self.lastTrick : lastTrick // ignore: cast_nullable_to_non_nullable
...
as List<OnlineRequisitionSnapshot>,requisitionHeldNominations: null == requisitionHeldNominations ? _self.requisitionHeldNominations : requisitionHeldNominations // ignore: cast_nullable_to_non_nullable
as List<OnlineTrickPlaySnapshot>,transitionEvents: null == transitionEvents ? _self.transitionEvents : transitionEvents // ignore: cast_nullable_to_non_nullable
as List<EngineTransitionEvent>,scores: null == scores ? _self.scores : scores // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int year,  int phase,  int currentPlayer,  int waitingPlayer,  bool waitingForExternalAction,  int lead,  int trumpSelector,  int trump,  int trickCount,  bool isFamine,  List<OnlinePlayerSnapshot> players,  List<OnlineSuitCardsSnapshot> jobPiles,  List<OnlineSuitCardsSnapshot> revealedJobs,  List<OnlineEngineCard> managedRewardOffers,  List<int> claimedJobs,  List<OnlineSuitValueSnapshot> workHours,  List<OnlineSuitCardsSnapshot> jobBuckets,  List<OnlineSuitCardsSnapshot> accumulatedJobCards,  List<OnlineTrickPlaySnapshot> currentTrick,  int currentTrickWinner,  List<OnlineTrickPlaySnapshot> lastTrick,  int lastWinner,  List<OnlineSuitCardsSnapshot> exiled,  List<OnlineSuitPlayersSnapshot> exiledPlayers,  List<OnlineAssignmentSnapshot> pendingAssignments,  List<OnlineRequisitionSnapshot> requisitionEvents,  List<OnlineTrickPlaySnapshot> requisitionHeldNominations, @JsonKey(fromJson: _transitionEventsFromJson)  List<EngineTransitionEvent> transitionEvents,  List<OnlineScoreSnapshot> scores,  int winnerID,  List<int> swapConfirmed,  List<int> swapCount,  List<int> passConfirmed,  OnlineEngineCard finalYearTrumpCard)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnlineEngineSnapshot() when $default != null:
return $default(_that.year,_that.phase,_that.currentPlayer,_that.waitingPlayer,_that.waitingForExternalAction,_that.lead,_that.trumpSelector,_that.trump,_that.trickCount,_that.isFamine,_that.players,_that.jobPiles,_that.revealedJobs,_that.managedRewardOffers,_that.claimedJobs,_that.workHours,_that.jobBuckets,_that.accumulatedJobCards,_that.currentTrick,_that.currentTrickWinner,_that.lastTrick,_that.lastWinner,_that.exiled,_that.exiledPlayers,_that.pendingAssignments,_that.requisitionEvents,_that.requisitionHeldNominations,_that.transitionEvents,_that.scores,_that.winnerID,_that.swapConfirmed,_that.swapCount,_that.passConfirmed,_that.finalYearTrumpCard);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int year,  int phase,  int currentPlayer,  int waitingPlayer,  bool waitingForExternalAction,  int lead,  int trumpSelector,  int trump,  int trickCount,  bool isFamine,  List<OnlinePlayerSnapshot> players,  List<OnlineSuitCardsSnapshot> jobPiles,  List<OnlineSuitCardsSnapshot> revealedJobs,  List<OnlineEngineCard> managedRewardOffers,  List<int> claimedJobs,  List<OnlineSuitValueSnapshot> workHours,  List<OnlineSuitCardsSnapshot> jobBuckets,  List<OnlineSuitCardsSnapshot> accumulatedJobCards,  List<OnlineTrickPlaySnapshot> currentTrick,  int currentTrickWinner,  List<OnlineTrickPlaySnapshot> lastTrick,  int lastWinner,  List<OnlineSuitCardsSnapshot> exiled,  List<OnlineSuitPlayersSnapshot> exiledPlayers,  List<OnlineAssignmentSnapshot> pendingAssignments,  List<OnlineRequisitionSnapshot> requisitionEvents,  List<OnlineTrickPlaySnapshot> requisitionHeldNominations, @JsonKey(fromJson: _transitionEventsFromJson)  List<EngineTransitionEvent> transitionEvents,  List<OnlineScoreSnapshot> scores,  int winnerID,  List<int> swapConfirmed,  List<int> swapCount,  List<int> passConfirmed,  OnlineEngineCard finalYearTrumpCard)  $default,) {final _that = this;
switch (_that) {
case _OnlineEngineSnapshot():
return $default(_that.year,_that.phase,_that.currentPlayer,_that.waitingPlayer,_that.waitingForExternalAction,_that.lead,_that.trumpSelector,_that.trump,_that.trickCount,_that.isFamine,_that.players,_that.jobPiles,_that.revealedJobs,_that.managedRewardOffers,_that.claimedJobs,_that.workHours,_that.jobBuckets,_that.accumulatedJobCards,_that.currentTrick,_that.currentTrickWinner,_that.lastTrick,_that.lastWinner,_that.exiled,_that.exiledPlayers,_that.pendingAssignments,_that.requisitionEvents,_that.requisitionHeldNominations,_that.transitionEvents,_that.scores,_that.winnerID,_that.swapConfirmed,_that.swapCount,_that.passConfirmed,_that.finalYearTrumpCard);case _:
  throw StateError('Unexpected subclass');
...
class _OnlineEngineSnapshot implements OnlineEngineSnapshot {
  const _OnlineEngineSnapshot({required this.year, required this.phase, required this.currentPlayer, required this.waitingPlayer, required this.waitingForExternalAction, required this.lead, required this.trumpSelector, required this.trump, required this.trickCount, required this.isFamine, required final  List<OnlinePlayerSnapshot> players, required final  List<OnlineSuitCardsSnapshot> jobPiles, required final  List<OnlineSuitCardsSnapshot> revealedJobs, final  List<OnlineEngineCard> managedRewardOffers = const [], required final  List<int> claimedJobs, required final  List<OnlineSuitValueSnapshot> workHours, required final  List<OnlineSuitCardsSnapshot> jobBuckets, required final  List<OnlineSuitCardsSnapshot> accumulatedJobCards, required final  List<OnlineTrickPlaySnapshot> currentTrick, this.currentTrickWinner = -1, required final  List<OnlineTrickPlaySnapshot> lastTrick, required this.lastWinner, required final  List<OnlineSuitCardsSnapshot> exiled, final  List<OnlineSuitPlayersSnapshot> exiledPlayers = const [], required final  List<OnlineAssignmentSnapshot> pendingAssignments, required final  List<OnlineRequisitionSnapshot> requisitionEvents, final  List<OnlineTrickPlaySnapshot> requisitionHeldNominations = const [], @JsonKey(fromJson: _transitionEventsFromJson) final  List<EngineTransitionEvent> transitionEvents = const [], required final  List<OnlineScoreSnapshot> scores, required this.winnerID, required final  List<int> swapConfirmed, required final  List<int> swapCount, final  List<int> passConfirmed = const [], this.finalYearTrumpCard = const OnlineEngineCard(suit: -1, value: 0)}): _players = players,_jobPiles = jobPiles,_revealedJobs = revealedJobs,_managedRewardOffers = managedRewardOffers,_claimedJobs = claimedJobs,_workHours = workHours,_jobBuckets = jobBuckets,_accumulatedJobCards = accumulatedJobCards,_currentTrick = currentTrick,_lastTrick = lastTrick,_exiled = exiled,_exiledPlayers = exiledPlayers,_pendingAssignments = pendingAssignments,_requisitionEvents = requisitionEvents,_requisitionHeldNominations = requisitionHeldNominations,_transitionEvents = transitionEvents,_scores = scores,_swapConfirmed = swapConfirmed,_swapCount = swapCount,_passConfirmed = passConfirmed;
...
@override List<OnlineSuitCardsSnapshot> get revealedJobs {
 ...
 final  List<OnlineEngineCard> _managedRewardOffers;
@override@JsonKey() List<OnlineEngineCard> get managedRewardOffers {
  if (_managedRewardOffers is EqualUnmodifiableListView) return _managedRewardOffers;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_managedRewardOffers);
}
...
@override@JsonKey() final  int currentTrickWinner;
...
@override List<OnlineRequisitionSnapshot> get requisitionEvents {
 ...
 final  List<OnlineTrickPlaySnapshot> _requisitionHeldNominations;
@override@JsonKey() List<OnlineTrickPlaySnapshot> get requisitionHeldNominations {
  if (_requisitionHeldNominations is EqualUnmodifiableListView) return _requisitionHeldNominations;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_requisitionHeldNominations);
}

 final  List<EngineTransitionEvent> _transitionEvents;
@override@JsonKey(fromJson: _transitionEventsFromJson) List<EngineTransitionEvent> get transitionEvents {
  if (_transitionEvents is EqualUnmodifiableListView) return _transitionEvents;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_transitionEvents);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OnlineEngineSnapshot&&(identical(other.year, year) || other.year == year)&&(identical(other.phase, phase) || other.phase == phase)&&(identical(other.currentPlayer, currentPlayer) || other.currentPlayer == currentPlayer)&&(identical(other.waitingPlayer, waitingPlayer) || other.waitingPlayer == waitingPlayer)&&(identical(other.waitingForExternalAction, waitingForExternalAction) || other.waitingForExternalAction == waitingForExternalAction)&&(identical(other.lead, lead) || other.lead == lead)&&(identical(other.trumpSelector, trumpSelector) || other.trumpSelector == trumpSelector)&&(identical(other.trump, trump) || other.trump == trump)&&(identical(other.trickCount, trickCount) || other.trickCount == trickCount)&&(identical(other.isFamine, isFamine) || other.isFamine == isFamine)&&const DeepCollectionEquality().equals(other._players, _players)&&const DeepCollectionEquality().equals(other._jobPiles, _jobPiles)&&const DeepCollectionEquality().equals(other._revealedJobs, _revealedJobs)&&const DeepCollectionEquality().equals(other._managedRewardOffers, _managedRewardOffers)&&const DeepCollectionEquality().equals(other._claimedJobs, _claimedJobs)&&const DeepCollectionEquality().equals(other._workHours, _workHours)&&const DeepCollectionEquality().equals(other._jobBuckets, _jobBuckets)&&const DeepCollectionEquality().equals(other._accumulatedJobCards, _accumulatedJobCards)&&const DeepCollectionEquality().equals(other._currentTrick, _currentTrick)&&(identical(other.currentTrickWinner, currentTrickWinner) || other.currentTrickWinner == currentTrickWinner)&&const DeepCollectionEquality().equals(other._lastTrick, _lastTrick)&&(identical(other.lastWinner, lastWinner) || other.lastWinner == lastWinner)&&const DeepCollectionEquality().equals(other._exiled, _exiled)&&const DeepCollectionEquality().equals(other._exiledPlayers, _exiledPlayers)&&const DeepCollectionEquality().equals(other._pendingAssignments, _pendingAssignments)&&const DeepCollectionEquality().equals(other._requisitionEvents, _requisitionEvents)&&const DeepCollectionEquality().equals(other._requisitionHeldNominations, _requisitionHeldNominations)&&const DeepCollectionEquality().equals(other._transitionEvents, _transitionEvents)&&const DeepCollectionEquality().equals(other._scores, _scores)&&(identical(other.winnerID, winnerID) || other.winnerID == winnerID)&&const DeepCollectionEquality().equals(other._swapConfirmed, _swapConfirmed)&&const DeepCollectionEquality().equals(other._swapCount, _swapCount)&&const DeepCollectionEquality().equals(other._passConfirmed, _passConfirmed)&&(identical(other.finalYearTrumpCard, finalYearTrumpCard) || other.finalYearTrumpCard == finalYearTrumpCard));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,year,phase,currentPlayer,waitingPlayer,waitingForExternalAction,lead,trumpSelector,trump,trickCount,isFamine,const DeepCollectionEquality().hash(_players),const DeepCollectionEquality().hash(_jobPiles),const DeepCollectionEquality().hash(_revealedJobs),const DeepCollectionEquality().hash(_managedRewardOffers),const DeepCollectionEquality().hash(_claimedJobs),const DeepCollectionEquality().hash(_workHours),const DeepCollectionEquality().hash(_jobBuckets),const DeepCollectionEquality().hash(_accumulatedJobCards),const DeepCollectionEquality().hash(_currentTrick),currentTrickWinner,const DeepCollectionEquality().hash(_lastTrick),lastWinner,const DeepCollectionEquality().hash(_exiled),const DeepCollectionEquality().hash(_exiledPlayers),const DeepCollectionEquality().hash(_pendingAssignments),const DeepCollectionEquality().hash(_requisitionEvents),const DeepCollectionEquality().hash(_requisitionHeldNominations),const DeepCollectionEquality().hash(_transitionEvents),const DeepCollectionEquality().hash(_scores),winnerID,const DeepCollectionEquality().hash(_swapConfirmed),const DeepCollectionEquality().hash(_swapCount),const DeepCollectionEquality().hash(_passConfirmed),finalYearTrumpCard]);
...
as List<OnlineSuitCardsSnapshot>,managedRewardOffers: null == managedRewardOffers ? _self._managedRewardOffers : managedRewardOffers // ignore: cast_nullable_to_non_nullable
as List<OnlineEngineCard>,claimedJobs: null == claimedJobs ? _self._claimedJobs : claimedJobs // ignore: cast_nullable_to_non_nullable
...
as List<OnlineTrickPlaySnapshot>,currentTrickWinner: null == currentTrickWinner ? _self.currentTrickWinner : currentTrickWinner // ignore: cast_nullable_to_non_nullable
as int,lastTrick: null == lastTrick ? _self._lastTrick : lastTrick // ignore: cast_nullable_to_non_nullable
as List<OnlineTrickPlaySnapshot>,lastWinner: null == lastWinner ? _self.lastWinner : lastWinner // ignore: cast_nullable_to_non_nullable
...
as List<OnlineRequisitionSnapshot>,requisitionHeldNominations: null == requisitionHeldNominations ? _self._requisitionHeldNominations : requisitionHeldNominations // ignore: cast_nullable_to_non_nullable
as List<OnlineTrickPlaySnapshot>,transitionEvents: null == transitionEvents ? _self._transitionEvents : transitionEvents // ignore: cast_nullable_to_non_nullable
as List<EngineTransitionEvent>,scores: null == scores ? _self._scores : scores // ignore: cast_nullable_to_non_nullable
as List<OnlineScoreSnapshot>,winnerID: null == winnerID ? _self.winnerID : winnerID // ignore: cast_nullable_to_non_nullable
