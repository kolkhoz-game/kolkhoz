...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get variantManagedEconomyTitle => 'Пятилетку — в четыре года';

  @override
  String get variantManagedEconomyDescription =>
      'Раздайте каждому игроку по закрытому тузу; туз треф определяет первого Центрального плановика. В годы 1–4 Плановик предварительно заменяет открытые награды картами той же масти, подтверждает расклад и выбирает козырь. После каждого года невостребованные награды возвращаются в колоду рабочих. Плановик пропускает обмен игроков; остальные обмениваются с первого года. В пятом году наград нет.';
